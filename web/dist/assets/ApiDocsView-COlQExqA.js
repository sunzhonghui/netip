...
}`}];return(V,n)=>(d(),i("div",P,[r(x,{title:"API 开发接口文档",description:"NetIP 提供面向 Shell / DDNS 脚本的轻量纯文本接口，以及适合程序调用的标准化 RESTful JSON API",icon:l(b)},null,8,["icon"]),e("div",y,[e("div",S,[e("div",w,[r(l(g),{class:"w-4 h-4 text-brand-400"}),n[0]||(n[0]=e("span",{class:"text-slate-200 font-bold"},"终端快捷使用示例 (CLI Quick Start)",-1))])]),e("div",A,[e("div",k,[e("span",$,"curl https://4."+o(l(t)),1),r(p,{text:`curl https://4.${l(t)}`,label:"复制"},null,8,["text"])]),e("div",O,[e("span",C,"curl https://6."+o(l(t)),1),r(p,{text:`curl https://6.${l(t)}`,label:"复制"},null,8,["text"])]),e("div",j,[e("span",I,"curl https://test."+o(l(t)),1),r(p,{text:`curl https://test.${l(t)}`,label:"复制"},null,8,["text"])])])]),e("div",N,[(d(),i(v,null,f(u,(a,m)=>e("div",{key:m,class:"custom-card p-6 space-y-4"},[e("div",D,[e("div",E,[e("span",{class:T(["px-2 py-0.5 rounded text-xs font-mono font-bold uppercase",a.method==="GET"?"bg-blue-100 text-blue-800 dark:bg-blue-900/60 dark:text-blue-200":"bg-emerald-100 text-emerald-800 dark:bg-emerald-900/60 dark:text-emerald-200"])},o(a.method),3),e("span",H,o(a.url),1)]),e("span",L,o(a.title),1)]),e("p",G,o(a.desc),1),e("div",X,[e("div",q,[e("div",B,[n[1]||(n[1]=e("span",null,"调用示例:",-1)),r(p,{text:a.example,"icon-only":!0},null,8,["text"])]),e("pre",U,o(a.example),1)]),e("div",F,[n[2]||(n[2]=e("div",{class:"flex items-center justify-between text-slate-400 font-sans"},[e("span",null,"响应示例:")],-1)),e("pre",M,o(a.response),1)])])])),64))])]))}});export{K as default};
