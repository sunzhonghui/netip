import{_ as h}from"./ToolHeader.vue_vue_type_script_setup_true_lang-CfPey6ys.js";import{_ as p}from"./CopyButton.vue_vue_type_script_setup_true_lang-CaeMxTuk.js";import{c as u,d as _,a as d,e as r,u as l,b as e,t as o,F as b,k as v,o as i,n as f}from"./index-Dl4jtV5e.js";/**
 * @license lucide-vue-next v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const T=u("CodeXmlIcon",[["path",{d:"m18 16 4-4-4-4",key:"1inbqp"}],["path",{d:"m6 8-4 4 4 4",key:"15zrgr"}],["path",{d:"m14.5 4-5 16",key:"e7oirm"}]]);/**
 * @license lucide-vue-next v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const g=u("TerminalIcon",[["polyline",{points:"4 17 10 11 4 5",key:"akl6gq"}],["line",{x1:"12",x2:"20",y1:"19",y2:"19",key:"q2wloq"}]]),P={class:"space-y-6"},y={class:"rounded-xl p-6 bg-slate-950 text-slate-100 font-mono space-y-4 border border-slate-800/90 shadow-md"},S={class:"flex items-center justify-between text-xs text-slate-400 border-b border-slate-800 pb-3 font-sans"},w={class:"flex items-center gap-2 font-semibold"},A={class:"space-y-3 text-xs sm:text-sm"},k={class:"flex items-center justify-between gap-4 p-3 rounded-lg bg-black border border-slate-800"},$={class:"text-emerald-400 font-mono font-medium"},C={class:"flex items-center justify-between gap-4 p-3 rounded-lg bg-black border border-slate-800"},O={class:"text-purple-400 font-mono font-medium"},I={class:"flex items-center justify-between gap-4 p-3 rounded-lg bg-black border border-slate-800"},j={class:"text-blue-400 font-mono font-medium"},N={class:"space-y-6"},E={class:"flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 dark:border-slate-800 pb-3"},D={class:"flex items-center gap-3"},H={class:"font-mono text-sm font-bold text-slate-800 dark:text-slate-200"},L={class:"text-xs text-slate-500 font-medium"},G={class:"text-xs sm:text-sm text-slate-600 dark:text-slate-400 leading-relaxed"},X={class:"grid grid-cols-1 lg:grid-cols-2 gap-4 text-xs font-mono"},q={class:"space-y-1.5"},B={class:"flex items-center justify-between text-slate-400 font-sans"},U={class:"p-3.5 rounded-lg bg-black border border-slate-800 text-emerald-400 overflow-x-auto whitespace-pre-wrap"},F={class:"space-y-1.5"},M={class:"p-3.5 rounded-lg bg-black border border-slate-800 text-slate-200 overflow-x-auto max-h-40"},K=_({__name:"ApiDocsView",setup(R){const s=window.location.hostname,c=s.split(".");let t=s;c.length>2&&(t=c.slice(1).join("."));const m=[{title:"纯文本 IPv4 地址获取 (脚本 / DDNS / cURL)",method:"GET",url:`https://4.${t}/`,desc:"仅配置 A 记录，返回调用者的公网 IPv4 地址与换行符。",example:`curl https://4.${t}`,response:"123.123.123.123"},{title:"纯文本 IPv6 地址获取",method:"GET",url:`https://6.${t}/`,desc:"仅配置 AAAA 记录，返回调用者的公网 IPv6 地址与换行符。",example:`curl https://6.${t}`,response:"240e:390:1234::1"},{title:"网络双栈优先级连通 IP",method:"GET",url:`https://test.${t}/`,desc:"同时配置 A 与 AAAA 记录，根据客户端首选连接协议返回地址。",example:`curl https://test.${t}`,response:"240e:390:1234::1"},{title:"JSON 格式 IP 地址",method:"GET",url:`https://4.${t}/json`,desc:"返回当前客户端 IP 及 IP 协议版本号。",example:`curl https://4.${t}/json`,response:`{
  "ip": "123.123.123.123",
  "version": 4
...
}`}];return(V,n)=>(i(),d("div",P,[r(h,{title:"API 开发接口文档",description:"NetIP 提供面向 Shell / DDNS 脚本的轻量纯文本接口，以及适合程序调用的标准化 RESTful JSON API",icon:l(T)},null,8,["icon"]),e("div",y,[e("div",S,[e("div",w,[r(l(g),{class:"w-4 h-4 text-brand-400"}),n[0]||(n[0]=e("span",{class:"text-slate-200 font-bold"},"终端快捷使用示例 (CLI Quick Start)",-1))])]),e("div",A,[e("div",k,[e("span",$,"curl https://4."+o(l(t)),1),r(p,{text:`curl https://4.${l(t)}`,label:"复制"},null,8,["text"])]),e("div",C,[e("span",O,"curl https://6."+o(l(t)),1),r(p,{text:`curl https://6.${l(t)}`,label:"复制"},null,8,["text"])]),e("div",I,[e("span",j,"curl https://test."+o(l(t)),1),r(p,{text:`curl https://test.${l(t)}`,label:"复制"},null,8,["text"])])])]),e("div",N,[(i(),d(b,null,v(m,(a,x)=>e("div",{key:x,class:"custom-card p-6 space-y-4"},[e("div",E,[e("div",D,[e("span",{class:f(["px-2 py-0.5 rounded text-xs font-mono font-bold uppercase",a.method==="GET"?"bg-blue-100 text-blue-800 dark:bg-blue-900/60 dark:text-blue-200":"bg-emerald-100 text-emerald-800 dark:bg-emerald-900/60 dark:text-emerald-200"])},o(a.method),3),e("span",H,o(a.url),1)]),e("span",L,o(a.title),1)]),e("p",G,o(a.desc),1),e("div",X,[e("div",q,[e("div",B,[n[1]||(n[1]=e("span",null,"调用示例:",-1)),r(p,{text:a.example,"icon-only":!0},null,8,["text"])]),e("pre",U,o(a.example),1)]),e("div",F,[n[2]||(n[2]=e("div",{class:"flex items-center justify-between text-slate-400 font-sans"},[e("span",null,"响应示例:")],-1)),e("pre",M,o(a.response),1)])])])),64))])]))}});export{K as default};
